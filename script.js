...
function modal(id,closeId,okId){const m=$(id);$(closeId).onclick=()=>m.classList.remove("open");if(okId && $(okId))$(okId).onclick=()=>m.classList.remove("open");return m}
const idea=modal("#ideaModal","#closeIdea"),notify=modal("#notifyModal","#closeNotify","#notifyOk");
...
// V4 SUGGESTION FORM TO EMAIL INTEGRATION
